...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Archcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"archcointools.com", "dnsseed.archcointools.com"},
    {"archcoinpool.org", "dnsseed.archcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"archcointools.com", "testnet-seed.archcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Archcoin is probably already running."), addrBind.ToString().c_str());
        else
